...
namespace EmployeePayCompute.Persistence.Migrations
{
    ...
    [Migration("20210212134227_Initial Migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmployeePayCompute.Entity.Employee", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("NationalInsurenceNo")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
            ...
            modelBuilder.Entity("EmployeePayCompute.Entity.PaymentRecord", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EmployeePayCompute.Entity.TaxYear", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EmployeePayCompute.Entity.PaymentRecord", b =>
                {
                    b.HasOne("EmployeePayCompute.Entity.Employee", "Employee")
                        .WithMany("PaymentRecord")
                        .HasForeignKey("EmployeeID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EmployeePayCompute.Entity.TaxYear", "TaxYear")
                        .WithMany()
